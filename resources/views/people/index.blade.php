        ...
        <ul id="content">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 pl-0">
                 <div class="col-lg-6 col-md-12 col-sm-6 pl-0"> 
                     <img src="{{asset('assets/Image/dar1.png')}}" alt="" width="150"> 
                 </div> 
                 <br>
                 <br>
                <div class="col-lg-12 col-md-12 col-sm-12 pl-0">
                    <img src="{{asset('assets/Image/dar2.png')}}" alt="" width="150" >
                </div>
            </div>
            <li class="open-tab">
                        ...
                        <div class="dis-table-cell">
                            ...
                            <div class="table-content contact">
                                ...
                                <div class="head animatt-fast">
                                    ...
                                    <h1 class="main-title" >{{__('participant.title15')}} {{__('participant.title16')}}</h1>
                                    ...
                                    <p class="animatt-middium"></p>
                                        ...
                                        <!--    <p class="animatt-middium">{{__('participant.text18')}}-->
                                        <!--    <br>{{$houses->wing}}-->
                                        <!--    <br>{{__('participant.text19')}}  {{$houses->first_periode}} {{__('participant.text20')}} </p>-->
                                        <!--@else-->
                                            <p class="animatt-middium">{{__('participant.text18')}}
                                            <br><b>{{$houses->wing}}</b>
                                            <br>{{__('participant.text19')}}  {{$houses->last_periode}}  {{__('participant.text21')}} </p>
                                        <!--@endif-->
